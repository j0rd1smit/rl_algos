...
class QLearningAgent:
    ...
    def update(self, state, action, reward, next_state):
        ...
        updated_q = (1 - lr) * self.get_qvalue(state, action) + lr * target
        # updated_q = (1 - lr) * self.get_value(state) + lr * target
    ...
    def get_best_action(self, state):
        ...
        for action in possible_actions:
            if self.get_qvalue(state, action) > best_q_value:
                best_action = action
                best_q_value = self.get_qvalue(state, action)
